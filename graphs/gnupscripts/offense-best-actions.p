...
set title "Max Fitness, pop: 50, gen: 50, episodes: 15, selection: 35%, mutation: 50%, mutationFactor: 20, moveTo"
set key outside
...
plot "info/offenseActionsDist.txt" u 1 title "offense - Move"       with lines lw 2 smooth csplines,\
     ...
     "info/offenseActionsDist.txt" u 8 title "offense - Pass11"     with lines lw 2 smooth csplines,\
     "info/offenseActionsDist.txt" u 9 title "offense - MoveTo"     with lines lw 2 smooth csplines
